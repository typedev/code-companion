...
│   Project Manager   │
│                     │
│  > my-project       │──────>  [New Process] Project Window (my-project)
│    other-project    │
│                     │──────>  [New Process] Project Window (other-project)
│  [+ Open Folder]    │
└─────────────────────┘
```
...
│                                                     │
│  ┌───────────────────────────────────────────────┐  │
│  │ 📁 my-project                      12 sessions│  │
│  │    ~/projects/my-project                      │  │
│  ├───────────────────────────────────────────────┤  │
│  │ 📁 other-project                   5 sessions │  │
│  │    ~/work/other-project                   [×] │  │
│  ├───────────────────────────────────────────────┤  │
│  │ 📁 new-project                     0 sessions │  │
│  │    ~/new-project                          [×] │  │
│  └───────────────────────────────────────────────┘  │
│                                                     │
│  [+ Open Folder]                                    │
...
- Delete button [×] only for projects with 0 sessions
...
```
┌─────────────────────────────────────────────────────────────────────┐
│  [Claude 🟢]  [+ Terminal]                        ~/my-project [×]  │
├─────────────────┬───────────────────────────────────────────────────┤
│ 📁 Files        │ [History] [Claude ×] [main.py ×] [Terminal 2 ×]   │
│ ├── 📁 src/     ├───────────────────────────────────────────────────┤
│ │   ├── main.py │                                                   │
│ │   └── 📁 utils│                                                   │
│ ├── 📁 tests/   │            < Tab Content >                        │
...
- **Claude button**: Opens Claude terminal tab, runs `claude` command
  - 🟢 Active: no Claude tab open
  - 🔴 Disabled: Claude tab already exists
...
- Double-click file → opens in new tab (or focuses existing tab)
...
```
src/
├── app.py                    # Application entry, NON_UNIQUE
├── project_manager.py        # Project Manager window
├── project_window.py         # Project Window (replaces window.py)
├── models/
│   ├── project.py           # Add: is_registered, can_delete
│   └── ...
├── services/
│   ├── history.py
│   ├── project_registry.py  # NEW: manage registered projects
│   └── ...
├── widgets/
│   ├── file_tree.py         # NEW: file tree sidebar
│   ├── file_editor.py       # NEW: editable code view
│   ├── tab_terminal.py      # NEW: terminal in tab
│   ├── tab_history.py       # NEW: history view as tab
│   ├── session_view.py
│   ├── code_view.py
│   └── ...
└── utils/
...
- [x] Terminal uses system font and Dracula colors
- [x] Terminal line height from ptyxis settings
- [x] File editor uses Dracula color scheme
- [x] Claude tab auto-closes when shell exits
- [x] Project Manager: single click selects, double click opens
- [ ] Keyboard shortcuts
